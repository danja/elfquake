...
76. Repeat the matched suite across seeds and only interpret VLF when the holdout contains observed VLF variation. The current VLF mask is constant in the real holdout, so its apparent contribution is unidentifiable.
