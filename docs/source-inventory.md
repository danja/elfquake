...
| **Japan ISEE VLF/ELF network** | Passive natural-radio context | `https://stdb2.isee.nagoya-u.ac.jp/vlf/`; [ERGSC CDF archive](https://ergsc.isee.nagoya-u.ac.jp/data/ergsc/ground/vlf/) | plots and CDF spectra | **Research sample verified**: two Moshiri CDF files decoded with station metadata and units; scientific-use permission confirmed. Keep Japan separate from the Italy production dataset. See [vlf-japan-isee.md](vlf-japan-isee.md). |
