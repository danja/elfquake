...
HEIGHT="${HEIGHT:-256}"
STEPS="${STEPS:-20000}"
OUT="${OUT:-$ROOT/real_vlf_synthetic_inlier_transfer.json}"
EMBEDDINGS_OUT="${EMBEDDINGS_OUT:-$ROOT/real_vlf_synthetic_inlier_transfer_embeddings.csv}"
...
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=src "$PYTHON_BIN" -m elfquake.cli evaluate-synthetic-inlier-transfer \
